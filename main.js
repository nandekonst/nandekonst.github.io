...
/***/ "./node_modules/@ionic/core/dist/ionic/svg sync ./src!./src!./node_modules/file-loader/dist/cjs.js?name=[name].[ext]&outputPath=svg!./src .svg$":
/*!**************************************************************************************************************************************************!*\
...
webpackContext.id = "./node_modules/@ionic/core/dist/ionic/svg sync ./src!./src!./node_modules/file-loader/dist/cjs.js?name=[name].[ext]&outputPath=svg!./src .svg$";
...
/* harmony import */ var _services_jexia_data_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/jexia-data.service */ "./src/app/services/jexia-data.service.ts");
...
/* harmony import */ var _jexia_ng_jexia__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @jexia/ng-jexia */ "./node_modules/@jexia/ng-jexia/fesm5/jexia-ng-jexia.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: [
                ...
                _jexia_ng_jexia__WEBPACK_IMPORTED_MODULE_11__["NgJexiaModule"].initialize({
                    projectID: '58c0dce5-5290-4504-a0da-9d43b3f9453d',
                    key: '9f156831-547c-4c22-876e-6e4ffaeed229',
                    secret: 'kjqaeCiuOOdt5raM',
                    providers: [
                        _jexia_ng_jexia__WEBPACK_IMPORTED_MODULE_11__["DataOperationsModule"],
                    ],
                })
            ],
            providers: [
                _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
                _services_jexia_data_service__WEBPACK_IMPORTED_MODULE_3__["JexiaDataService"],
...
/***/ "./src/app/services/jexia-data.service.ts":
/*!************************************************!*\
  !*** ./src/app/services/jexia-data.service.ts ***!
  \************************************************/
/*! exports provided: JexiaDataService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JexiaDataService", function() { return JexiaDataService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _jexia_ng_jexia__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @jexia/ng-jexia */ "./node_modules/@jexia/ng-jexia/fesm5/jexia-ng-jexia.js");
/* harmony import */ var jexia_sdk_js_api_dataops_filteringApi__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! jexia-sdk-js/api/dataops/filteringApi */ "./node_modules/jexia-sdk-js/api/dataops/filteringApi.js");
/* harmony import */ var jexia_sdk_js_api_dataops_filteringApi__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(jexia_sdk_js_api_dataops_filteringApi__WEBPACK_IMPORTED_MODULE_2__);
...
var JexiaDataService = /** @class */ (function () {
    function JexiaDataService(dataOperations) {
        this.dataOperations = dataOperations;
        //create a property from type Dataset with ITeacher interface and set it dataset teachers
        this.teacherdataset = this.dataOperations.dataset('teachers');
        //select it and execute it 
        this.teachers = this.teacherdataset.select().execute();
        //initalize behaviorsubject
        this.teacherSource = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](null);
        //subscribe to the current Message
        this.currentMessage = this.teacherSource.asObservable();
    }
    JexiaDataService.prototype.updateTeachers = function (teacherobj) {
        var _this = this;
        var filterCondition = Object(jexia_sdk_js_api_dataops_filteringApi__WEBPACK_IMPORTED_MODULE_2__["field"])("location").isEqualTo(teacherobj.city);
        var filteredTeachers = this.teacherdataset.select().where(filterCondition).execute().then(function (data) {
            //sending out the messagestream
            _this.teacherSource.next(data);
        });
    };
    JexiaDataService.prototype.getAllTeachers = function () {
        var _this = this;
        this.teachers.then(function (data) {
            _this.teacherSource.next(data);
        });
    };
    JexiaDataService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [_jexia_ng_jexia__WEBPACK_IMPORTED_MODULE_1__["DataOperations"]])
    ], JexiaDataService);
    return JexiaDataService;
}());
...
module.exports = __webpack_require__(/*! C:\Users\Omnia\Documents\teacher-app\src\main.ts */"./src/main.ts");
